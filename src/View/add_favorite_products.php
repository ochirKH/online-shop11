<form action="/add-product-favorite" method="POST">
    <div class="container">
        <h1>Добавить товар в избранные</h1>
        ...
        <button type="submit" class="registerbtn">Добавить в избранные</button>
    </div>
</form>
